...
namespace sdk
{
	...
	{
	public:
		IMaterial* find_material(char const* material_name, const char* group_name, bool complain = true, const char* complain_prefix = 0) {
			using original_fn = IMaterial * (__thiscall*)(IVMaterialSystem*, char const*, const char*, bool, const char*);
			return (*(original_fn**)this)[84](this, material_name, group_name, complain, complain_prefix);
		}
		IMaterial* create_material(const char* material, key_values* keyval) {
			using original_fn = IMaterial * (__thiscall*)(IVMaterialSystem*, char const*, key_values*);
			return (*(original_fn**)this)[83](this, material, keyval);
		}
		material_handle_t first_material() {
			using original_fn = material_handle_t(__thiscall*)(IVMaterialSystem*);
			return (*(original_fn**)this)[86](this);
		}
		material_handle_t next_material(material_handle_t handle) {
			using original_fn = material_handle_t(__thiscall*)(IVMaterialSystem*, material_handle_t);
		...
		IMaterial* get_material(material_handle_t handle) {
			using original_fn = IMaterial * (__thiscall*)(IVMaterialSystem*, material_handle_t);
			return (*(original_fn**)this)[89](this, handle);
		}
		int	get_materials_count() {
			using original_fn = int(__thiscall*)(IVMaterialSystem*);
